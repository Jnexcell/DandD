...
## Files
- **[`the-weeping-grove.md`](the-weeping-grove.md)** — **the module** (run this): overview + MMOS worksheet → how-to-run → cold open → map of play → 4 modular scenes → the Showdown (two versions) → endings + hooks → **Appendix A** (all 7 stat blocks inlined) → **Appendix B** (clue/clock/scene trackers).
- *(add as you prep: `handouts/`, `map.md`, `mother-sere.md`, etc.)*

## Run it live
Say **"run the session"** (or *"let's play The Weeping Grove"*). The **DM Assistant**
(`../../tools/dm-assistant.md`) loads **`modules/the-weeping-grove/the-weeping-grove.md`**, walks the scenes,
conducts combat, and tracks live state in `../../sessions/`. Build the party first with the **Character
Creator** (`../../tools/character-creator.md`) if you haven't.
